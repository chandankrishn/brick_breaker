System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Mainscript", Mainscript = (_dec = ccclass('Mainscript'), _dec2 = property(Button), _dec3 = property(Prefab), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec6 = property(Sprite), _dec7 = property(Sprite), _dec8 = property(Prefab), _dec9 = property(Prefab), _dec10 = property(SpriteFrame), _dec11 = property(SpriteFrame), _dec(_class = (_class2 = (_temp = class Mainscript extends Component {
        constructor(...args) {
          super(...args);
        ...
        // serializableDummy = 0;
        coliderpatter() {
          let height = this.height / 2 - 70;
          let width = -(this.width / 2) + 100;
          let tile_width = 150;
